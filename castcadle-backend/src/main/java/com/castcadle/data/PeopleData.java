...
public class PeopleData {
    public static List<Person> getPeople() {
        ...
        people.add(new Person("Thor", "Male", true, "None", 2005, 1, false, "/images/Thor.jpg"));
        people.add(new Person("Turner", "Female", false, "Moderate", 2003, 4, true, "/images/Turner.jpg"));
        return people;
    }
}
